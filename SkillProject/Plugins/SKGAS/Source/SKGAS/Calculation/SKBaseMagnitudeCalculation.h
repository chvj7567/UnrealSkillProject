...
#include "SKBaseMagnitudeCalculation.generated.h"

UCLASS()
class SKGAS_API USKBaseMagnitudeCalculation : public UGameplayModMagnitudeCalculation
{
	GENERATED_BODY()
	
public:
	USKBaseMagnitudeCalculation();
